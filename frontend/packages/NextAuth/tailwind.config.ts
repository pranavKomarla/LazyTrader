...
// // ESM import works in TS; or use `const flowbite = require("flowbite/plugin")`
...
export default {
  ...
  content: [
    ...
    // Scan Flowbite-React + Flowbite so Tailwind can see the classes they use
  ...
  theme: {
    extend: {
      ...
      padding: { 30: "30px" },
      colors: {
        cyan: { 500: "var(--color-primary)", 600: "var(--color-primary)", 700: "var(--color-primary)" },
